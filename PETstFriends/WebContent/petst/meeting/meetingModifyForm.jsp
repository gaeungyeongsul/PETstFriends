             ...
             <article class="post" style="border: 1px solid #eeeeee;">
					...
					<div style="border-bottom: 2px solid brown; width: 22%;">
						<div style="text-align:left; border-bottom: 5px solid #FFD232; width: 630px;">
							<h2 style="font-family: 'NanumSquareRound', sans-serif; font-weight: bold; ">펫프 모여라 글수정</h2>
						</div>
					</div>
...
<table border="1" style="width: 1000px; margin: auto; border: 1px solid #eeeeee;">
<tr><td>
<table style="width: 400; background-color:white; color:black; border:1; border-color:#CD853F; border-radius:5px;">
<tr><td style="font-size: 16px; padding-left: 5px">
프로필 사진 &nbsp&nbsp 
<!-- <form id="fileForm" action="fileUpload" method="post" enctype="multipart/form-data"> -->
<!-- <input type="file" id="fileUp" name="fileUp" style="display:inline;" accept=".bmp, .gif, .jpg, .png" onchange="getThumbnailPrivew(this, 'avatar_image');"> -->
<!-- </form> -->
</td></tr>
...
<tr><td width="140" style="padding-left:10px; background-color:white; color:black; border:1; border-color:#dcdcdc;; border-radius:5px;"> 카테고리 / 모임명 </td><td width="460px;" height="50">
<input type="text"  id="title" maxlength="23" style="width: 450px; height: 40px; padding-left:10px; font-size: 16px;
background-color:white; color:black; border:1; border-color:#dcdcdc;border-radius:5px;" value="${meeting.meetingBoard_title}"></td></tr>
...
<tr><td width="140" style="padding-left:10px; background-color:white; color:black; border:1; border-color:#dcdcdc;; border-radius:5px;"> 모임일시 </td><td height="50" >
<input id="startmeetingdate" type="date" min="<%=dat %>" onkeydown="filterNumner(event);" style="
background-color:white; color:black; border:1; width: 130px;height:30px; border-color:#dcdcdc; border-radius:5px;">
<select id="startmeetingdate2" style="background-color:white; color:black; border:1; width: 60px;height:30px; border-color:#dcdcdc;; border-radius:5px;">
<%
int a0=0;
String b0="00";
int c=1;
...
background-color:white; color:black; border:1; width: 130px;height:30px; border-color:#dcdcdc; border-radius:5px;">
<select id="endmeetingdate2" style="background-color:white; color:black; border:1; width: 60px;height:30px; border-color:#dcdcdc; border-radius:5px;">
<%
a0=0;
b0="00";
c=1;
...
<tr><td width="140px" style="padding-left:10px; font-weight: bold; background-color:#dcdcdc; color:black; border:1; border-color:#dcdcdc;">기존 접수 일시</td><td> ${meeting.meetingBoard_startAcceptingDate } ~ ${meeting.meetingBoard_endAcceptingDate }</td></tr>

<tr><td width="140px" style="padding-left:10px; background-color:white; color:black; border:1; border-color:#dcdcdc; border-radius:5px;"> 접수기간 </td><td id="acceptdate" height="50" >
<input id="startmeetingacceptdate" type="date" min="<%=dat %>" onkeydown="filterNumner(event);" style="
background-color:white; color:black; border:1; width: 130px;height:30px; border-color:#dcdcdc; border-radius:5px;">
<select id="startmeetingacceptdate2" style="background-color:white; color:black; border:1; width: 60px;height:30px; border-color:#dcdcdc; border-radius:5px;">
<%
a0=0;
b0="00";
c=1;
...
background-color:white; color:black; border:1; width: 130px;height:30px; border-color:#dcdcdc; border-radius:5px;">
 <select id="endmeetingacceptdate2" style="background-color:white; color:black; border:1; width: 60px;height:30px; border-color:#dcdcdc; border-radius:5px;">
 <%
 a0=0;
 b0="00";
 c=1;
...
%>
 ...
 <%} %>
					...
					%>
<tr><td style="padding-left:10px; background-color:white; color:black; border:1; border-color:#dcdcdc; border-radius:5px;" > 모임장소 </td><td id="place" height="250">
...
<form name="form" id="form" method="post">
	<table style="width: 600px">
			<tbody>
				<tr>
					<td style="padding-left:10px; width: 50%; border:2; border-color:#dcdcdc; border-radius:5px; width: 90px; padding: 5px; 
					background-color:white; color:black; border:1; border-color:#dcdcdc; border-radius:5px;" >도로명주소</td>
					<td><input type="hidden" id="confmKey" name="confmKey" value=""  >
					<input value="<%=place1%>" readonly="readonly" type="text" id="roadAddrPart1" style="width:370px; background-color:white; color:#dcdcdc; 
					font-family: 'NanumSquareRound',sans-serif; padding: 4px; border:1; 
	                border-color:#dcdcdc;border-radius: 5px;"></td>
					<td><input type="button"  value="주소검색" onclick="goPopup();" style="background-color: #dcdcdc; border: none; padding: 5px 10px; border-color:#dcdcdc;
									 border-radius: 5px; color: white;"></td>
				</tr>
				<tr>
					<td width="130" style="background-color:white; color:black; border:1; border-color:#dcdcdc; border-radius:5px;" >상세주소<input type="hidden" id="btn"></td>
					<td colspan="2">
						<input type="text" id="addrDetail" value="<%=place2%>" style="width:450px; background-color:white; color:black; font-family: 'NanumSquareRound',sans-serif; padding: 4px; border:1; 
...
<tr><td colspan="2">
<table border="1"  style="width: 1000px; border-color:#B77E2C;">
<tr>
<td width="1000" height="50" style="font-size:22px; background-color:white; color:#7a7373; border:1; border: 1px solid #eeeeee; border-radius:5px;">모임상세 내용 입력</td></tr>
</table>
...
<table style="margin: auto; width: 1000px; border-color:#dcdcdc;"><tr><td>
