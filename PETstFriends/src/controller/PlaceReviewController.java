...
public class PlaceReviewController {
	...
	public String checkPlace(Model model, @RequestParam(defaultValue="0") int randomnum, 
		...
		String mainKey = randomnum==0?"종로구":randomnum==1?"서울":randomnum==2?"부산":randomnum==3?"인천":
			randomnum==4?"대구":randomnum==5?"대전":randomnum==6?"광주":randomnum==7?"울산":"제주";
		String mainPlace = randomnum2==0?" 동물병원":randomnum2==1?" 애견카페":randomnum2==2?" 애묘카페":randomnum2==3?" 반려동물 호텔":" 공원";
		String mainPlace1 = randomnum2==0?"p0":randomnum2==1?"p1":randomnum2==2?"p2":randomnum2==3?"p5":"p6";
