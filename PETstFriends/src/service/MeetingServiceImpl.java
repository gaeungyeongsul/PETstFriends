...
public class MeetingServiceImpl implements MeetingService{
	...
	@Override
	public MeetingBoardApply selectApplyone(String meetingBoardApply_userId, int meeting_boardno) {
		// TODO Auto-generated method stub
		HashMap<String, Object> params = new HashMap<String, Object>();
		params.put("meetingBoardApply_userId", meetingBoardApply_userId);
		params.put("meeting_boardno", meeting_boardno);
		applyDao.deleteApply(params);
		return applyDao.selectOneApplyboard(params);
	}
	@Override
	...
	@Override
	public MeetingLikes selectreviewLikesOne(int Meeting_boardno, int reviewno, String meetingLikes_userId) {
		// TODO Auto-generated method stub
		HashMap<String, Object> param = new HashMap<String, Object>();
		param.put("meeting_boardno", Meeting_boardno);
		param.put("reviewno", reviewno);
		param.put("meetingLikes_userId", meetingLikes_userId);
		return reviewLikesDao.selectReviewLikesOne(param);
	}
	@Override
